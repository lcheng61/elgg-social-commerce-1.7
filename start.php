<?php
	...
	function socialcommerce_init() {
		...
		// Extend CSS
			extend_view("css", "{$CONFIG->pluginname}/css");
			extend_view("js", "{$CONFIG->pluginname}/js/behavior");
			extend_view("js", "{$CONFIG->pluginname}/js/rating");
			extend_view("index/righthandside", "{$CONFIG->pluginname}/products_list",600);
			extend_view("index/righthandside", "{$CONFIG->pluginname}/most_popular_products",600);
			
			
			extend_view("owner_block/extend", "{$CONFIG->pluginname}/owner_block",500);
			
			extend_view("page_elements/header_contents", "{$CONFIG->pluginname}/header");
			
			extend_view("metatags", "{$CONFIG->pluginname}/extend_header");
			
			extend_view("page_elements/footer", "{$CONFIG->pluginname}/extend_footer",400);
		
		// Extend hover-over menu	
			extend_view("profile/menu/links","{$CONFIG->pluginname}/menu");
